...
$getid = $_GET['id'];
$query = mysql_query("select * from pelanggan join tarif on (pelanggan.id_tarif=tarif.id_tarif) where pelanggan.idpelanggan='$getid'");
            ...
            <div class="col-md-10" style="height:100%;float:right;padding:0;">
                ...
                <div class="rows">
                    <div class="col-md-12 bottom-utama">
                            ...
                            <div class="rows">
                                  <a href="pengguna.php" class="btn btn-danger btn-sm" style="margin-top:10px;"><i class="glyphicon glyphicon-remove"></i> &nbsp; Kembali</a>
